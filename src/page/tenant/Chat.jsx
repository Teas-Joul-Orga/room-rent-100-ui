              ...
              {contacts.map(contact => {
                ...
                >
                  ...
                  <Box flex="1" overflow="hidden">
                    ...
                    <Text fontSize="sm" color={unread > 0 ? "blue.500" : "gray.500"} fontWeight={unread > 0 ? "bold" : "normal"} isTruncated>MANAGEMENT</Text>
                  </Box>
                  {unread > 0 && (
          ...
          <>
            <Flex p={4} borderBottom="1px solid" borderColor={borderColor} align="center" gap={3} bg={threadHeaderBg}>
              ...
              <Box>
                ...
                <Text fontSize="xs" color="gray.500">Contact Management</Text>
              </Box>
            </Flex>
            <Box flex="1" p={6} overflowY="auto" display="flex" flexDirection="column" gap={4}>
               {messages.length === 0 && (
                  <Flex flex="1" justify="center" align="center" direction="column" color={noMessagesColor}>
                     ...
                     <Text mt={4}>Start a conversation with Property Management</Text>
                  </Flex>
               )}
               {messages.map((msg) => {
           ...
           <Flex flex="1" direction="column" justify="center" align="center" color="gray.400" textAlign="center" px={10}>
              ...
              <Text fontSize="xl" fontWeight="bold" color={textColor} mb={2}>RoomRent Support</Text>
              <Text>Need help? Message Property Management here.</Text>
           </Flex>
        )}
      </Box>
